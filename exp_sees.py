...
class MyExpGroup(ExperimentGroup):
    def __init__(self, hyperParams: HyperParams) -> None:
        ...
        self.variable_name = 'nif_sees_vowel'
        self.variable_value = hyperParams.nif_sees_vowel
...
for nif_sees_vowel in [False, True]:
    hP = deepcopy(template)
    hP.nif_sees_vowel = nif_sees_vowel
    hP.ready(globals())
